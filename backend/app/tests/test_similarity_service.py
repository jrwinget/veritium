...
class TestSimilarityService:
    ...
    async def test_calculate_similarity(self, similarity_service):
        ...
        document_content = (
            "Studies show that regular exercise is beneficial for heart health..."
        )
    ...
    def test_preprocess_text(self, similarity_service):
        messy_text = (
            "This   text   has   [citations]   and   (Smith et al., 2020)   references"
        )
    ...
    async def test_calculate_entailment_score(self, similarity_service):
        ...
        result_support = await similarity_service.calculate_entailment_score(
        ...
        result_contradict = await similarity_service.calculate_entailment_score(
